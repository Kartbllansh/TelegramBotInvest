...
public class BigMessage {
    public static final String CONSENT_MESSAGE = "Правила использования бота для обучения инвестированию:"+ EmojiParser.parseToUnicode(":arrow_down")+"\n" +
            "\n" +
    ...
    public static final String HELP_MESSAGE = "Список доступных команд:\\n\"\n" +
            "                + \"/cancel - отмена выполнения текущей команды;\\n\"\n" +
            "                + \"/registration - регистрация пользователя;\\n\"\n" +
            "                + \"/wallet - получить информацию о вашем кошельке\"\n" +
            "                + \"/buy - покупка ценной бумаги;\\n\"\n" +
            "                + \"/sell - продажа ценной бумаги";
    public static final String START_MESSAGE = "Добро пожаловать в мир виртуальной торговли нашего бота! Здесь ты можешь развивать свои навыки инвестирования," +
